...
export function createMaterials() {
  ...
  return {
    ...
    fruit: paintedMaterial({ color: 0xb8783e, emissive: 0x4f2d18, emissiveIntensity: 0.05 }),
    fruitAlt: paintedMaterial({ color: 0x9b5f65, emissive: 0x402126, emissiveIntensity: 0.04 }),
    fruitProduction: paintedMaterial({ color: 0xa56238, emissive: 0x472213, emissiveIntensity: 0.05 }),
    fruitOpenSource: paintedMaterial({ color: 0x3d7c76, emissive: 0x123a35, emissiveIntensity: 0.05 }),
    fruitAcademic: paintedMaterial({ color: 0x706592, emissive: 0x292540, emissiveIntensity: 0.05 }),
    fruitPrototype: paintedMaterial({ color: 0x9c5d78, emissive: 0x3d1d30, emissiveIntensity: 0.04 }),
    fruitPersonal: paintedMaterial({ color: 0xaa8141, emissive: 0x4a3112, emissiveIntensity: 0.05 }),
    marker: barkMaterial(0xd19a61),
    signboard: naturalMaterial({ color: 0xd8b07a, roughness: 0.88, metalness: 0.02 }),
    signboardEdge: naturalMaterial({ color: 0x8a6238, roughness: 0.92 }),
    nail: naturalMaterial({ color: 0x9a9da3, roughness: 0.42, metalness: 0.72 }),
